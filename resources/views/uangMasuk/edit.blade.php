...
<header>
    ...
    <form action="{{route('uangMasuk.update', $masuk->id)}}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('nominal') is-invalid @enderror" id="nominal" placeholder="Masukan Nominal" name="nominal" value="{{$masuk->nominal ?? old('nominal')}}">
                        @error('nominal') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleInputSumber">Sumber</label>
                        <input type="text" class="form-control @error('sumber') is-invalid @enderror" id="exampleInputsumber" placeholder="Nama Pemberi Dana" name="sumber" value="{{$masuk->sumber ?? old('sumber')}}">
                        @error('sumber') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleInputTanggal">Tanggal</label>
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="exampleInputPassword" placeholder="Masukan Tanggal" name="tanggal" value="{{$masuk->tanggal ?? old('tanggal')}}">
